...
summary: ''
authors: []
lastmod: '2020-08-22T17:23:10+03:00'
featured: no
image:
  caption: ''
  focal_point: ''
...
The passwords in the nerdy-pop,password-related,single alphanumeric and sport categories take the longest time to crack. This can be validated by the average strenght of the passwords based on their categories

```{r strenght_of_psd ,message=FALSE,warning=FALSE,dpi=200}
