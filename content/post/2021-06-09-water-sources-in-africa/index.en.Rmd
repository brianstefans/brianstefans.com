...
we are going to be looking at the water sources in Africa. The data used is from one of the TidyTuesday datasets and it can be retrieved from [here](http://openpsychometrics.org/_rawdata/BIG5.zip).
